...
// Output "2012-09-26"
                ...
                PreparedStatement ps7 = con.prepareStatement("select Faculty_ID,Subject_Code,Muster_Name,Subject_Name from Theory_Muster_Allocation where Academic_Year=? and Year=? and Branch=? and Division=? and Semester=? ");
                ...
                PreparedStatement ps8 = con.prepareStatement("select Student_ID,Student_Name from " + stu_muster);
        ...
        %>
        <div align="center" style="color: white"><h1>Theory-Attendance From = <font color="yellow"><%=Date_F%></font> To = <font color="yellow"><%=Date_T%></font> </h1></div>
        ...
        <table align="center">
            ...
            %>
            <th>
                Lecture(s) Attended in <%=subject_name%>
            </th>
            <th>
                Total Lecture(s) in <%=subject_name%>
            </th>
            <%
                    }
                }
                ...
                if (rs7.next()) {
                    ...
                    while (rs7.next()) {
                        ...
                        for (int i = 0; i < count_str; i++) {
                            PreparedStatement ps6 = con.prepareStatement("select " + str.get(i) + " from " + table_name + " where Student_ID=? ");
    ...
    <div align="center">
        ...
        <button onclick="window.location.href = 'Form25_GD_Range_Wise_Pr.jsp'" id="b3">View Practical Attendance</button>

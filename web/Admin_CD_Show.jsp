    ...
    <body>
        ...
        <%
            ...
            if (ses.getAttribute("empid") == null || ses.getAttribute("empid").equals("")) {
                ...
                try {
                    PreparedStatement ps = con.prepareStatement("select * from Course_Details");
                    ResultSet rs = ps.executeQuery();

                    if (!rs.next()) {
                        request.setAttribute("errorMessage", "<center><font color='red'><b><h3>Courses not yet Assigned...</h3></b></font></center>");
                        request.getRequestDispatcher("Admin_Home.jsp").include(request, response);
                    } else {
                        rs.beforeFirst();                        
        %>
        <br>
        <div align="center" class="lab"><h2>Courses Assigned</h2></div>
        <table border="2">
...
<%
                    request.setAttribute("errorMessage", "<center><font color='red'><b><h2>No Courses Allocated Yet.....</h2></b></font></center>");
                    request.getRequestDispatcher("Admin_Home.jsp").include(request, response);
                } finally {
                    con.close();
                }

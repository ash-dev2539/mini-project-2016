...
<html>
    ...
    <body>
        ...
        <%
            ...
            if (ses.getAttribute("empid") == null || ses.getAttribute("empid").equals("")) {
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("select distinct Branch from Course_Details where Course_Name=? and Academic_Year=? ");
        ...
        %>       
        <div align="right" style="position:absolute;top:20px;right:10px;font-size: 30px;color: white"><marquee>Welcome Dr. <%=rs1.getString(1)%></marquee> </div>
        ...
        <div id="login">
            ...
            <form action="Principal_Check.jsp" method="post">
<table style="width: 60%">
                ...
                <tr><td class="lab">Branch</td><td> <select style="width: 300px;font-size: 20px" name="branch" onchange="sendInfoo()" id="branch" required>                           
                ...
                <tr><td class="lab">Year</td><td> <select style="width: 300px;font-size: 20px" name="year" id='year' required>
            ...
            <div align="center" class="content" id="testdiv" ><span class="lab" style="background: whitesmoke">
                ...
                %>       
<div align="center"><button onclick="window.location.href = 'Principal_Profile.jsp'">Back</button></div>
        ...
        <%
                    ...
                    request.getRequestDispatcher("Form6_CD.jsp").include(request, response);
                } finally {
                    con.close();
                }
            }%>

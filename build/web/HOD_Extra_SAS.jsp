            ...
            if (ses.getAttribute("empid") == null || ses.getAttribute("empid").equals("")) {
                ...
                try {
                   ...
                   String academic_year = (String)ses.getAttribute("academic_year");
                    ...
                    String ex_table = (String) ses.getAttribute("ex_table");
                    int ex_total = (Integer) ses.getAttribute("extra_total_count");
                    for (int i = 0; i < ex_theory; i++) {
                        ...
                        PreparedStatement ps = con.prepareStatement("insert into " + ex_table + " values(?, ?, ?)");
                    ...
                    request.getRequestDispatcher("HOD_Extra_SA.jsp").include(request, response);
                } finally {
                    con.close();
                }
            }

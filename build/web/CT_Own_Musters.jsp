...
<html>
    ...
    <body>
        ...
        <div align="center" style="color: white"><h1><b>Attendance Details</b></h1></div>
                    <%
                        ...
                        if (ses.getAttribute("empid") == null || ses.getAttribute("empid").equals("")) {
                            ...
                            try {
                                ...
                                System.out.println("ID: " + Academic_year);
                                ...
                                ps6.setInt(1, Faculty_ID);
                                ResultSet rs6 = ps6.executeQuery();
                                rs6.next();
                                String faculty_designation = rs6.getString(1);
                                ResultSet rs = null, rs1 = null;
                                if (faculty_designation.equals("Faculty")) {
                                    PreparedStatement ps0 = con.prepareStatement("select * from Month_Entry where Academic_Year=? and Year=? and Branch=? and Semester=? and Division=?");
                                ...
                                } else if (faculty_designation.equals("Principal") || faculty_designation.equals("Vice Principal")) {
        ...
        <table>
            ...
            <tr>
                <td class="hi" style="height: 10px"><%= rs.getString(1)%></td>
            ...
            <tr>
                ...
                <td class="hi" style="height: 10px"><%= rs1.getString(1)%></td>
        ...
        <div align="center">
            <button style="background: green" onclick="window.location.href = '<%=deliver%>'">Back</button>
        </div>
        <%
    ...
    <%
                    ...
                    request.setAttribute("errorMessage", "<font color='red'><center><b><h2>Academic month is not assigned yet by Class Teacher</h2></b></center></font>");
                    request.getRequestDispatcher(deliver).include(request, response);
                }
            } catch (Exception e) {
                request.setAttribute("errorMessage", "<font color='red'><center><b><h2>There is no Attendance present for you...Please Contact the Administrator...</h2></b></center></font>");
                request.getRequestDispatcher(deliver).include(request, response);
            }
        }
    %>

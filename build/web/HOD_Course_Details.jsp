    ...
    <body onload="sendInfoo()">
     ...
     <span  class="button" id="toggle-login">Welcome</span>
        ...
        <div id="login">
            ...
            <form action="HOD_Course_Details_Save.jsp" method="post">
<table>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <input style="width: 285px;font-size: 20px" type="text" class="follow" name="branch" id="branch" value="<%=branch%>" readonly/>
                    </td>
                </tr>  
                ...
                <tr>
                    <td class="lab">Theory Count</td>
                    <td>
                        <input style="width: 285px;font-size: 20px" pattern="[0-9]+" type="text" class="follow" name="th_count"  required/>
                    </td>
                </tr>

                <tr>
                    <td class="lab">Practical Count</td>
                    <td>
                        <input style="width: 285px;font-size: 20px" pattern="[0-9]+" type="text" class="follow" name="pr_count" required />
                    </td>
                </tr>
